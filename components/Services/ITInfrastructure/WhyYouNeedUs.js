    ...
    Why You Need Us
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <FeatureCard 
            ...
            title="Safeguard Business Data with Top-Tier Cybersecurity"
            description="Minimize risks and protect sensitive information from security breaches."
          />
          <FeatureCard 
            icon={<Code className="h-8 w-8 text-indigo-600" />}
            title="Ensure Seamless IT Operations"
            description="With ongoing support and maintenance, your IT systems stay operational and secure.
"
          />
          <FeatureCard 
            icon={<TrendingUp className="h-8 w-8 text-indigo-600" />}
            title="Access Comprehensive IT Solutions"
            description="From hardware to networking, we provide everything you need to optimize your IT
infrastructure."
          />
           <FeatureCard 
            icon={<Code className="h-8 w-8 text-indigo-600" />}
            title=" Maximize Business Continuity"
            description="Reliable infrastructure and proactive support mean fewer disruptions and more uptime.
"
          />
        </div>
