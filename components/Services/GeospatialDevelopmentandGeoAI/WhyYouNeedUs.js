    ...
    Why You Need Us
        ...
        <div className="grid gap-8 md:grid-cols-3 justify-center items-center">
          <FeatureCard 
            ...
            title="Gain Location-Based Insights"
            description="Unlock actionable insights to make smarter, location-driven decisions."
          />
          <FeatureCard 
            icon={<Code className="h-8 w-8 text-indigo-600" />}
            title="Optimize Route Planning and Logistics"
            description="Reduce costs and improve efficiency with advanced geospatial solutions"
          />
          <FeatureCard 
            icon={<TrendingUp className="h-8 w-8 text-indigo-600" />}
            title="Enhance Urban Development and Infrastructure Planning"
            description="Plan smarter cities and infrastructure with real-time, AI-enhanced spatial data."
          />
             <FeatureCard 
            icon={<Lightbulb className="h-8 w-8 text-indigo-600" />}
            title="Mitigate Risks and Save Resources"
            description="Make informed decisions to reduce risk and allocate resources efficiently."
          />
        </div>
