    ...
    Why You Need Us
        ...
        <div className="grid gap-8 md:grid-cols-3 justify-center items-center">
          <FeatureCard 
            ...
            description="Make faster and more accurate decisions with real-time reports and analytics"
          />
          <FeatureCard 
            icon={<Code className="h-8 w-8 text-indigo-600" />}
            title="Future-Proof Your Business Data"
            description="Scalable database solutions ensure long-term efficiency and security.
"
          />
          <FeatureCard 
            icon={<TrendingUp className="h-8 w-8 text-indigo-600" />}
            title="Enhance Business Intelligence"
            description="Unlock deeper insights into your operations with interactive dashboards."
          />
             <FeatureCard 
            icon={<Lightbulb className="h-8 w-8 text-indigo-600" />}
            title="Stay Ahead with Real-Time Reporting"
            description="Gain a competitive edge with up-to-the-minute insights tailored to your goals."
          />
        </div>
