    ...
    Why You Need Us
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <FeatureCard 
            ...
            description="We craft bespoke solutions that perfectly align with your unique business needs, ensuring optimal performance and efficiency."
          />
          <FeatureCard 
            icon={<Code className="h-8 w-8 text-indigo-600" />}
            title="End-to-End Development"
            description="From initial design concepts to final deployment, we handle every aspect of the development process with meticulous attention to detail."
          />
          <FeatureCard 
            icon={<TrendingUp className="h-8 w-8 text-indigo-600" />}
            title="Scalable and Secure"
            description="Our solutions are built to grow with your business, featuring robust security measures to protect your valuable data and operations."
          />
        </div>
